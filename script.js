...
//             event.target.setCustomValidity(`${event.target.id} can't empty `)
//         }
//         else{
...
inputTitle.addEventListener("input", checkInput(inputTitle))
inputTitle.addEventListener("input", checkInput(inputAuthor))
inputPages.addEventListener("input", checkInput(inputPages))
inputState.addEventListener("input", checkInput(inputState))
